...
# === Phase 2: mol → text ===
echo ">>> [Phase 2] mol2text Training..."
python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=${DATA_DIR}/molcap_chemdfm/train_${i}.parquet \
    data.val_files=${DATA_DIR}/molcap_chemdfm/test_100.parquet \
...
python /HOME/paratera_xy/pxy547/HDD_POOL/roundtrip/valid_final.py \
  --output_file /XYFS01/HDD_POOL/paratera_xy/pxy547/roundtrip/res/chemdfm_roundtrip_phase2_${i}.xlsx
